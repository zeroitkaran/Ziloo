...
//    var mainMsgsArr = [[String : Any]]()
    ...
    func sendPressed() {
        ...
        else
        {
            ...
            ChatDBhandler.shared.sendMessage(senderID: senderID, receiverID: receiverID, senderName: self.senderName, message: self.txtMessage.text!, seen: false, time: time, timestamp: time, type: "text") { (isSuccess) in
                if isSuccess == true{
                    print("Message Sent")
                }
            }
...
//        let dateString = dateFormatter.string(from: date)
        ...
        let time = arrMessages[indexPath.row]["time"] as? String ?? "time"
...
extension Date {
    func getFormattedDate() -> String {
        ...
        dateformat.dateFormat = "dd-MM-yyyy HH:mm:ss Z"
