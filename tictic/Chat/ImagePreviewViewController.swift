...
class ImagePreviewViewController: UIViewController, UIScrollViewDelegate
{
    ...
    override func viewDidLoad()
    {
        ...
        if isUserPofile == true{
           baseImg = BASE_URL + imgUrl
        }else{
            baseImg = imgUrl
        }
        ...
        imageView.sd_setImage(with: URL(string:baseImg), placeholderImage: UIImage(named: "videoPlaceholder"))
